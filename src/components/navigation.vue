<template>
  <nav class="navbar navbar-expand-md navbar-light bg-light navbar-fixed">
      <div class="container">
        <a class="navbar-brand"><router-link to="/">Bhav.AT</router-link></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link"><router-link to="/">Home</router-link>
            ...
            <li class="nav-item">
              <a class="nav-link"><router-link :to="{ name: 'allusers'}">Users</router-link></a>
            </li>
            <li class="nav-item">
              <a class="nav-link"><router-link :to="{ name: 'allprojects'}">Projects</router-link></a>
            </li>
            <!--<li class="nav-item">
            ...
            <li v-if="user" class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown">
                <a class="nav-link"><router-link :to="{ name: 'myprojects'}">My Projects</router-link></a>
                <a class="nav-link"><router-link :to="{ name: 'allchats'}">Chat</router-link></a>
                <a class="nav-link"><router-link :to="{ path: profilelink()}">My Profile</router-link></a>
              </div>
            </li>
          </ul>
